...
from redis_core.client import redis_client, RedisClient, NoScriptError
from redis_core.lua_script import SLIDING_WINDOW_COUNTER
...
def retrieve_rule(rule: str):
    """Функция вычисления правил работы с Limit."""
    try:
